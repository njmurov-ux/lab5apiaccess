...
This vignette demonstrates how to use the functions defined in the `lab5apiaccess` package to retrieve and plot map tiles from the Stadia Maps API.
...
```{r}
path = "~/.stadia_maps" # Use the file location on your machine
